...
public class TokenService {
    ...
    public ResponseEntity<?> deductTokensByUserId(Long userId, int tokensToDeduct) {
    ...
    public ResponseEntity<?> addTokensByUserId(Long userId, int tokensToAdd) {
        Debug.log("Adding " + tokensToAdd + " tokens to user with ID: " + userId);
        User user = userRepository.findById(userId).orElse(null);
        if (user == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(Map.of("error", "User not found"));

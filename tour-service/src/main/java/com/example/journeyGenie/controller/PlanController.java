...
public class PlanController {
    ...
    public ResponseEntity<?> commitPlan(@RequestBody Map<String, Object> planRequest, HttpServletRequest request) {
        try {
            ...
            UserResponseDTO userResponseDTO = userInterface.getUserByEmail(email);
            ...
            ResponseEntity<?> deductionResponse = userInterface.deductTokens(userResponseDTO.getId(), numberOfDays*userInterface.getTourGenerationTokenCostPerDay());
